	...
	void Ext_SurfaceFunction0 (inout Surface o, ShaderData d)
	{
        ...
        if(!_IsExempt && (lllllllllllllllllllllllllllllllllllllll || llllllllllllllllllllllllllllllllllllllll) ) {
            ...
            for (int i = 0; i < _ArrayLength; i++){
		        ...
		        #if _HDRP
                    float4 lllllllllllllllllllllllll = mul(UNITY_MATRIX_VP, float4(GetCameraRelativePositionWS(_PlayersPosArray[i].xyz), 1.0));
                    float4 llllllllllllllllllllllllll = ComputeScreenPos(lllllllllllllllllllllllll , _ProjectionParams.x);
		        #else
			        float4 lllllllllllllllllllllllll = mul(UNITY_MATRIX_VP, float4(_PlayersPosArray[i].xyz, 1.0));
                ...
                #if _HDRP
                    //float4 lllllllllllllllllllllllllll = mul(UNITY_MATRIX_VP, float4(GetCameraRelativePositionWS(d.worldSpacePosition), 1.0));
                    //fixed4 llllllllllllllllllllllllllll = ComputeScreenPos(lllllllllllllllllllllllllll , _ProjectionParams.x);
                    fixed4 llllllllllllllllllllllllllll = d.screenPos;
		        #else
                    float4 lllllllllllllllllllllllllll = mul(UNITY_MATRIX_VP, float4(d.worldSpacePosition.xyz, 1.0));
            ...
            fixed4 c = lerp(1, tex2D(_MainTex, d.texcoord0.xy), _TextureVisibility) * _Color;        
